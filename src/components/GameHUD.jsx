    ...
    <div className="fixed top-20 left-4 right-4 z-40 pointer-events-none">
      <div className="max-w-7xl mx-auto flex justify-between items-start gap-4">
        ...
        <div className="card p-5 pointer-events-auto space-y-2 backdrop-blur-xl">
          ...
          {(gameMode === 'collection' || gameMode === 'challenge') && timeRemaining !== null && (
            <div className="flex items-center gap-3">
              <span className={`text-xl font-bold ${timeRemaining < 10 ? 'text-red-400' : 'text-blue-400'}`}>
          ...
          {combo > 1 && (
            <div className="flex items-center gap-3">
              <span className="text-xl font-bold text-purple-400">x{combo}</span>
          ...
          {gameMode === 'reaction' && (
            <>
              <div className="flex items-center gap-3">
                <span className="text-xl font-bold text-orange-400">{explosionsUsed}/{maxExplosions}</span>
                <span className="text-xs text-slate-400 uppercase">Explosions</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xl font-bold text-pink-400">{chainReactions}</span>
